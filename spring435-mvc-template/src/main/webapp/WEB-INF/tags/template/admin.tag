  ...
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/">Spring435 MVC</a>
      </div>
        ...
        <ul class="nav navbar-nav">
        	<li class="dropdown">
        		...
        		<ul class="dropdown-menu">
            		<li><a href="<c:url value='/product'/>"><span class="glyphicon glyphicon-menu-humburger"></span>Products</a></li>
            		<li role="separetor" class="divider"></li>
            		<li><a href="<c:url value='/category'/>"><span class="glyphicon glyphicon-menu-humburger"></span>Categories</a></li>
            	</ul>
        	</li>
          	<li class="dropdown">
            	<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Cadastre <span class="caret"></span></a>
            	<ul class="dropdown-menu">
